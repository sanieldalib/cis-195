# Tutorial 3: Table View and Delegation
...
**Deadline:** Thursday, September 19th at **1:20pm**
...
![](/tutorials/tutorial-3/assets/fig1.png?raw=true)
...
Do the following:
1.  Create a txt file called `pennkey_cis195_tutorial3.txt` (I know I keep changing this, last time! I promise!)
...
Do the following:
1. Adding to your `pennkey_cis195_tutorial3.txt` file, note down 2 methods from UITableViewDelegate, and 3 from UITableViewDataSource, that you think are essential to create a fully functioning table view. If you think there are more methods that could be useful, note them down too!

---

## Submission

* Submit `pennkey_cis195_tutorial3.txt` on Canvas.
